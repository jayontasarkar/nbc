...
<head>
    ...
    <title>{{ language('Public Library Membership', 'পাবলিক লাইব্রেরির সদস্যপদ') }} | গণগ্রন্থাগার অধিদপ্তর</title>
		...
		<div class="sixteen columns">
			<div class="callbacks_container"
				...
				<ul class="rslides" id="front-image-slider">
					<li>
						<img src="{{ asset('images/reader1.png') }}" alt="" width="960" height="220"/> 
						<p class="caption">গণগ্রন্থাগার অধিদপ্তর - পাঠকক্ষ</p>          		
					</li>
					<li>
						<img src="{{ asset('images/reader3.jpg') }}" alt="" width="960" height="220"/> 
						<p class="caption">গণগ্রন্থাগার অধিদপ্তর - পাঠকক্ষ</p>      		
					</li>
					<li>     	
						<img src="{{ asset('images/reader2.png') }}" alt="" width="960" height="220"/> 
						<p class="caption">গণগ্রন্থাগার অধিদপ্তর - পাঠকক্ষ</p>    		
					</li>
				</ul>        
			</div>
			...
			<div role="navigation" id="dawgdrops">
				<ul class="meganizr mzr-slide mzr-responsive">
					...
					<li class="col1 mzr-drop">
						<a href="{{ url('membership/rules') }}" class="submenu">
							{{ language('Book lending rules', 'বই ধার দেয়ার নীতিমালা') }}
						</a>
					</li>
