...
Route::get('/divisions/{area}', 'DivisionsController@show')->name('division.show');
...
Route::get('verifications/{application}', 'ApplicationManagementController@show')->name('verifications.show');
